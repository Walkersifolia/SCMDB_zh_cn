...
|---|---|---|---|---|---|
| **4.10.1-live.12660092** (currently active) | 6349 | 6144 | 0 | 1720 | 69 |
...
- The "Translated" count uses the `tr != en` metric (entries actually displaying Chinese). The 205 untranslated entries are mission titles/descriptions (69; some official values are `~mission(...)` references), location IDs (60), crafting slots (64), a mining element fallback (1) and other untranslated labels (11; freight-elevator SCU tags, placeholder sentinels, UI numerics) — English fallbacks with no matching Chinese text, expected by design.
